...
import (
	...
	"github.com/maxtroughear/gqlgenc/clientv2"
	"github.com/maxtroughear/gqlgenc/example/annictV2/gen"
...
func main() {
	...
	annictClient := NewAnnictClient(clientv2.NewClient(pester.New(), "https://api.annict.com/graphql", func(ctx context.Context, req *http.Request, gqlInfo *clientv2.GQLRequestInfo, res interface{}, next clientv2.RequestInterceptorFunc) error {
